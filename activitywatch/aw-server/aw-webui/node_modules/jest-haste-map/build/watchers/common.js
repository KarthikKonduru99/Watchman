 ...
 *
 * @param {NodeWatcher|PollWatcher|ActivityWatchWatcher} watcher
 * @param {?object} opts
 * @return {boolean}
 * @public
 */
...
exports.assignOptions = function (watcher, opts) {
  ...
  if (opts.ActivityWatch && opts.ActivityWatchPath) {
    watcher.ActivityWatchPath = opts.ActivityWatchPath;
  }
