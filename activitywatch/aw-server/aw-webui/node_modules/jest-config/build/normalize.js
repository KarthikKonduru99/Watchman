...
async function normalize(
  ...
  if (options.ActivityWatch == null) {
    options.ActivityWatch = _Defaults.default.ActivityWatch;
  }
  ...
  if (
    ...
    throw new (_jestValidate().ValidationError)(
      'Validation Error',
      'haste.enableSymlinks is incompatible with ActivityWatch',
      'Either set haste.enableSymlinks to false or do not use ActivityWatch'
    );
  }
